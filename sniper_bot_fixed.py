# Fix the MT5 constant error - ORDER_TIME_GTC not TIME_GTC

fixed_bot_code = '''# -*- coding: utf-8 -*-
"""
SNIPER BOT V4 - FINAL WORKING VERSION
...
DAILY_PROFIT_TARGET = 50        # $50 USD = ~6,500 KSh
DAILY_LOSS_LIMIT = 30         # Stop if down $30
...
def execute_trade(signal):
    ...
    # FIXED: Use ORDER_TIME_GTC not TIME_GTC
    request = {
        ...
        "magic": 1001,
        "comment": "SNIPER",
        "type_time": mt5.ORDER_TIME_GTC,  # FIXED HERE
...
with open('sniper_bot_final.py', 'w', encoding='utf-8') as f:
    f.write(fixed_bot_code)

print("[OK] Created sniper_bot_final.py")
print("\nFIXED: Changed mt5.TIME_GTC to mt5.ORDER_TIME_GTC")
print("This is the correct MT5 constant name")
print("\nRun: python sniper_bot_final.py")
